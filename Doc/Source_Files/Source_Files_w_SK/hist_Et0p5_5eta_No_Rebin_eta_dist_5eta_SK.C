...
#endif
void hist_Et0p5_5eta_No_Rebin_eta_dist_5eta_SK()
{
//=========Macro generated from canvas: All_GEP_Algo/Histograms
//=========  (Mon Jun 12 11:17:49 2023) by ROOT version 6.26/06
   TCanvas *All_GEP_Algo = new TCanvas("All_GEP_Algo", "Histograms",0,151,1200,800);
   All_GEP_Algo->SetHighLightColor(2);
   All_GEP_Algo->Range(-6.890625,-0.01832316,6.890625,0.1649084);
   ...
   Calo_422__1->SetMaximum(0.1465853);
   ...
   Calo_420__2->SetMaximum(0.1465853);

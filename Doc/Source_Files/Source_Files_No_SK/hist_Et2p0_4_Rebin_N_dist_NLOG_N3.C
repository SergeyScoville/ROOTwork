...
#endif
void hist_Et2p0_4_Rebin_N_dist_NLOG_N3()
{
//=========Macro generated from canvas: All_GEP_Algo/Histograms
//=========  (Fri Jul 21 14:52:26 2023) by ROOT version 6.26/06
   TCanvas *All_GEP_Algo = new TCanvas("All_GEP_Algo", "Histograms",0,53,1200,800);
   gStyle->SetOptStat(0);
   All_GEP_Algo->SetHighLightColor(2);
   All_GEP_Algo->Range(-42.66666,-6.184201,224,1.217058);
   ...
   CalosP422__1->GetXaxis()->SetRange(1,52);
   ...
   CalosP420__2->GetXaxis()->SetRange(1,52);

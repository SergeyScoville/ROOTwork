...
//=========  (Thu Jun 15 17:27:27 2023) by ROOT version 6.26/06
   TCanvas *All_GEP_Algo = new TCanvas("All_GEP_Algo", "Histograms",0,151,1200,800);
   gStyle->SetOptStat(0);
   All_GEP_Algo->SetHighLightColor(2);
   All_GEP_Algo->Range(-80.41025,-0.01491335,422.1538,0.07829508);
   ...
   Calo_422__1->SetMaximum(0.07177049);
   ...
   Calo_420__2->SetMaximum(0.07177049);

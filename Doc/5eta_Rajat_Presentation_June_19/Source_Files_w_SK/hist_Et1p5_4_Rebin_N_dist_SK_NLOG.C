...
#endif
void hist_Et1p5_4_Rebin_N_dist_SK_NLOG()
{
//=========Macro generated from canvas: All_GEP_Algo/Histograms
//=========  (Fri Jun 16 18:59:02 2023) by ROOT version 6.26/06
   TCanvas *All_GEP_Algo = new TCanvas("All_GEP_Algo", "Histograms",0,53,1200,800);
   gStyle->SetOptStat(0);
   All_GEP_Algo->SetHighLightColor(2);
   All_GEP_Algo->Range(-80.41025,-4.961978,422.1538,-0.8310534);
   ...
   Calo_422__1->SetMaximum(0.07581967);
   ...
   Calo_420__2->SetMaximum(0.07581967);
